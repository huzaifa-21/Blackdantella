...
// Only serve the app via Nginx for static assets like JS/CSS
// Removed this: app.use(express.static(path.join(__dirname, "public"), { maxAge: "1y" }));
...
// Allow CORS for specific origins (useful for your admin interface)
app.options(
  "*",
  cors({
    origin: ["https://admin.blackdantella.com"],
