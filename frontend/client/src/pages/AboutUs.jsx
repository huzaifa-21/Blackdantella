    ...
    <div className="about-us">
      <Container>
        ...
        <p>
          ...
          to detail. Our collection is thoughtfully designed to provide comfort,
          versatility, and style, perfect for any occasion, whether casual or
          formal.
        </p>
        <p>
        ...
        <p>
          Our commitment to quality and customer satisfaction drives everything
          we do. From sourcing premium fabrics to ensuring excellent
          craftsmanship, we strive to bring you products that you will love and
