        ...
        <Container>
          ...
          <ol>
            <li>
              ...
              <p>
                We collect information to provide a better experience and
                improve our services. The types of information we collect
                include:
              </p>
              <ol type="A">
                <li>
                  ...
                  <ul>
                    <li>
                      <b>Contact information</b> (e.g., name, email address,
                      phone number).
                    </li>
                    <li>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      <b>Device information</b> (e.g., IP address, browser
                      type).
                    </li>
                    <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <b>Improve our services</b> by analyzing website performance
                  and user behavior.
                </li>
                <li>
                ...
                <li>
                  <b>Comply with legal obligations</b> as required under UAE
                  law.
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <p>
                ...
                not responsible for the privacy practices of such websites, and
